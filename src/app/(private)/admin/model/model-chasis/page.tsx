...
import { ModelChasisForm } from '@/components/admin/model/model-chasis/form'
import { ModelChasisTable } from '@/components/admin/model/model-chasis/table'
import { ModelChasisType } from '@/components/admin/model/model-chasis/type'
