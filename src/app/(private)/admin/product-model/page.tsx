...
import { ProductModelForm } from '@/components/admin/product-model/form'
import { ProductModelTable } from '@/components/admin/product-model/table'
import { ProductModelType } from '@/components/admin/product-model/type'
