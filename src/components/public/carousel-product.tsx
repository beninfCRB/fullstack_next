...
export const CarouselProductComponent: FunctionComponent<CarouselProductProps> = function ({ ...props }) {
    ...
    return (
        ...
        props.data.length > 0 &&
        (
            <Carousel orientation="vertical" className="flex flex-col lg:flex-row items-center justify-center gap-2 px-10 py-32">
                <div
                ...
                <div className="relative basis-3/4 h-[34rem]">
