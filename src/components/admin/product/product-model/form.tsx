...
import { ProductSelect } from '../product-main/select'
import { ProductType } from '../product-main/type'
import { TransmitionSelect } from '../../master/transmition/select'
import { TransmitionType } from '../../master/transmition/type'
import { TypeSelect } from '../../master/type/select'
                        ...
                        <div className="basis-full items-center justify-center">
                            ...
                            >
                                <CardWrapper
                                    ...
                                    headerLabel='Buat Data Model Produk'
                                >
                                    <FormMain {...form}>
                                        <form
